...
class KinovaRobot(object):
    def __init__(self):
        ...
        # Joint 6
        g0[:3, 3] = [0, -0.0246, self.l1 + self.l2 +
                     self.l3 + self.l4 + self.l5 + self.l6]
        self.joint_g0s.append(g0.copy())

        # Joint 7
        g0[:3, 3] = [0, -0.0246, self.l1 + self.l2 +
                     self.l3 + self.l4 + self.l5 + self.l6 + self.l7]
        self.joint_g0s.append(g0.copy())

        # EE
        g0[:3, 3] = [0, -0.0246, self.l1 + self.l2 + self.l3 +
                     self.l4 + self.l5 + self.l6 + self.l7 + self.l8]
        self.ee_g0 = g0.copy()
...
def test():
    ...
    q = np.array([0, np.pi / 4, np.pi, -np.pi /
                 4, 0, 3 * np.pi / 2, np.pi / 2])
